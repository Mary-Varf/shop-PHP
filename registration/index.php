...
<main class="page-authorization" id='login-form'>
    ...
    <form class="custom-form" id='reg_form' action="" method="post">
        <input id="surname" class="custom-form__input" type="text"  required="" name="surname" value="<?php echo htmlspecialchars($data['surname'] ?? ''); ?>" placeholder='Фамилия*'>
        <input id="usersname" class="custom-form__input" type="text"  required="" name="usersname" value="<?php echo htmlspecialchars($data['usersname'] ?? ''); ?>"  placeholder='Имя*'> 
