...
<main class="page-authorization" id='login-form'>
  ...
  <form class="custom-form" action="" method="post">
    ...
    <input type="email" class="custom-form__input" required=""  id="email_id" name="email" minlength="3" placeholder="Ваш email:" value="<?=htmlspecialchars(isset($_COOKIE['login']) ? $_COOKIE['login'] : '') ?>">
