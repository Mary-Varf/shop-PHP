...
include $_SERVER['DOCUMENT_ROOT'] . "/admin/products/add/addChangeHandler.php";
$message = '';
...
<main class="page-add">
    ...
    <h1 class="h h--1"><?php echo (!isset($data[0]) ? 'Добавление товара' : 'Измение товара'); ?></h1>
        <fieldset class="page-add__group custom-form__group">
            ...
            <?php
                if (isset($data[0])) {
                    ...
                    <input type="text" id="id" name="id" value="' . ($_GET['change_id'] ?? '') . '" hidden>';
                }
            ?>
            <label for="product-name" class="custom-form__input-wrapper page-add__first-wrapper">
                <input type="text" class="custom-form__input" name="productName" id="productName" placeholder='Название товара*' required value="<?php echo htmlspecialchars($data[0]['name'] ?? ''); ?>">
            </label>
            <label for="product-price" class="custom-form__input-wrapper">
                <input type="text" class="custom-form__input" name="productPrice" id="productPrice" placeholder='Цена товара*' required  value="<?php echo htmlspecialchars($data[0]['price'] ?? ''); ?>">
            </label>
        </fieldset>
        <fieldset class="page-add__group custom-form__group">
