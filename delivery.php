...
<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=AD_DEL_PRICE?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=FREE_DEL_PRICE?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=(AD_DEL_PRICE * 2)?> РУБ</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=AD_DEL_PRICE?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=FREE_DEL_PRICE?> РУБ)</b>
        <p class="page-delivery__item-desc">
